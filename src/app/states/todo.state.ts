...
import { AddTodo, RemoveTodo, GetTodos, SetSelectedTodo, UpdateTodo } from '../actions/todo.action';
...
export class TodoState {
    ...
    @Action(RemoveTodo)
    deleteTodo({ getState, setState }: StateContext<TodoStateModel>, { id }: RemoveTodo) {
